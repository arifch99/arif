...
<body>
<div align="left"><a href="month oct.php"><img src="graphics/back.png" width="90" height="75" /></a><a href="http://localhost/School/menu.html"><img src="graphics/Home-icon.png" width="67" height="64" /></a></div>
...
$date=$_POST['date'];
$fee=$_POST['fee'];
$query1="INSERT INTO `oct`(`roll_no`,`class`,`fee`,`date`) VALUES ('$roll','$class','$fee','$date')";
