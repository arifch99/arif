...
<body>
<div align="left"><a href="month february.php"><img src="graphics/back.png" width="90" height="75" /></a><a href="http://localhost/School/menu.html"><img src="graphics/Home-icon.png" width="67" height="64" /></a></div>
...
$fee=$_POST['fee'];
$date=$_POST['date'];
$query1="INSERT INTO `feb`(`roll_no`,`class`,`fee`,`date`) VALUES ('$roll','$class','$fee','$date')";
