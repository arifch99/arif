...
<br/><br/><div align="center" id="fee">
  <h2><em><strong>Select File to save into Database</strong></em></h2>
</div>
        <div align="center"><form method="post" enctype="multipart/form-data" action="admin files submit.php">
          <p><br/>
      ...
      &nbsp;<input type="file" name="image" />
          ...
          <br/><br/>
            ...
            <br/><br/>
            *Only pdf, jpg, png format supported</p>
        </form>
        </div>
