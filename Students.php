...
<h1><em><strong>Registered Students</strong></em></h1></div>
<?php
...
?>
<div align="center"><table width="93%" style="width:80%">
<?php
echo "<b><tr><th>" .'Reg. #'. "</th><th>".'Student Name'."</th><th>" .'Father Name'."</th><th>" .'Class'."</th><th>" .'Date of Birth'."</th><th>" .'Gender'."</th><th>" .'Address'."</th><th>" .'Contact'."</th></tr><br/></b>";
