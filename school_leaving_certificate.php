...
<br/>
<div align="center">
<h1 id="fee"><em>School Leaving Certificate</em></h1></div>
<br/>
<div align="center" id="rollno">
 <h2><em>Select Class and Enter Roll Number to generate certificate</em> </h2>
 <br/>
<form method="post"  action="school_leaving_certificate_1.php"> 
