...
<br/>
<div align="center">
<h1 id="fee"><em>Student Record Portal</em></h1></div>
<br/>
<div align="center" id="rollno">
 <h2><em>Select Class and Enter Roll Number to search student</em> </h2>
 <br/>
<form method="post"  action="search_student (2).php"> 
